...
2. Having compiled the program for profiling, you now need to run it to
   ...
   There are many kinds of profiles that can be generated by configuring
   RTS options. In this chapter we are going to describe a various
   kinds of them. Some profiles
   require further processing with additional tools after running the
   program.
